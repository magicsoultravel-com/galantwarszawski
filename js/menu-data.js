/* ============================================================ *
 *  STATIC MENU DATA — Restauracja Galant Warszawski
 *  Categories + dishes embedded as JS so the menu modal works on
 *  any static host (including file://, without fetch()).
 *  Bilingual: *_pl / *_en  (SITE_LANG is set on each HTML page).
 * ============================================================ */
