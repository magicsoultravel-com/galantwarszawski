...
function render_tree($items, $level = 0) {
    ...
    foreach ($items as $item) {
        if ($item['type'] === 'dir') {
            ...
            if (is_admin() && in_array($item['ext'], $allowedViewEditExtensions)) {
                echo '<a href="javascript:void(0);" class="replace-file-btn" data-file-path="' . htmlspecialchars(urlencode($item['download_param'])) . '" title="Replace with Clipboard">🔄</a>';
            }
...
<div id="fileEditorModal" class="modal-overlay">
    <div class="modal-content">
        ...
        <div class="modal-buttons">
            ...
            <span id="saveFeedback" class="modal-status"></span>
